...
import { inviteLehrperson, type EinladungResult } from '@/app/(app)/einstellungen/_actions'
...
export function LpEinladungForm() {
  ...
  return (
    <form action={action} className="flex gap-2 items-end">
      <div className="flex-1">
        <Label htmlFor="lp-email">E-Mail-Adresse</Label>
        <Input
          id="lp-email"
          name="email"
          type="email"
